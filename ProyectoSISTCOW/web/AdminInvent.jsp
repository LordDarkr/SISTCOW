            ...
            <div class="main">
              ...
              <center>
                ...
                <center>
                        ...
                        <table cellspacing='0' id="results"> <!-- cellspacing='0' is important, must stay -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=i.getTipoTela()%></td>
                                    <td><%=i.getColor()%></td>
                                    <td><a href="AdminEditInventory.jsp?idp=<%=i.getIdProducto()%>&&nomp=<%=i.getNombreProducto()%>&&canp=<%=i.getCantidad()%>&&tco=<%=i.getTipoCortina()%>&&tte=<%=i.getTipoTela()%>&&col=<%=i.getColor()%>">
                                        <img src="web/images/configuration.png" width="30" height="30"></a></td>
                    ...
                    <a href="ExcelReports/ReportInvent.jsp" class="greenbtn">Exportar a Excel</a>
                </center>
