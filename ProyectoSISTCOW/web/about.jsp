				...
				<div class="section group">
				   <div class="labout span_1_of_about">
				    ...
				    <div class="cont span_2_of_about">
                        ...
                        <HR>
                        <h3>Visi&oacute;n</h3>
					   	<p>Ser una empresa lider en el mercado ofreciendo una amplia gama de servicios y en continuo crecimiento, distinguiendose por ofrecer una gran calidad de servicios de excelencia a nuestros clientes e inovando cada uno de nuestros productos ademas de generar más empleos.</p>
