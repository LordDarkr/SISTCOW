...
<div class="mens">    
 ...
 <center>
      ...
      <br/>
 <center> <h3 class="m_3">Desactivar Cuenta</h3></center>
        <center> <h3 class="m_3"> </h3></center>
     <center>
    <br/>
    
     <div class="col_1_of_CHP span_1_of_CHP">
         <strong> Ten en cuenta que si desactivas tu cuenta te perderas de promociones y productos que d&iacute;a a d&iacute;a estamos ofreciendo. ¿Est&aacute;s de seguro de que deseas cancelar tu cuenta (Esta acci&oacute;n no se podr&aacute;¡ deshacer)?</strong> 
     
     
<br/>
<br/>
     
<a href="#" class="redbtn">Desactivar Cuenta</a>
<br/>
    </div>                         
