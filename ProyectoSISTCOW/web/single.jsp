...
<body>
    	<div class="header-top">
			<div class="wrap"> 
			 ...
			 <div class="cssmenu">
				<ul>
					<li class="active"><a href="login.html">Cuenta</a></li> |
	...
	<div class="header-bottom">
	    <div class="wrap">
			...
			<li class="active grid"><a href="Smooth_Curtains.html">Cortinas Lisas	</a></li>
			<li><a class="color4" href="Roman_Curtains.html">Cortinas Romanas</a>
				
				</li>				
				<li><a class="color5" href="Japanese_Panels.html">Paneles Japoneses</a>
				</li>
				<li><a class="color6" href="Shutters.html">Persianas</a></li>
			</ul>
			</div>
			</div>
		</div>
		...
		<ul class="icon1 sub-icon1 profile_img">
			<li><a class="active-icon c2" href="#"> </a>
				<ul class="sub-icon1 list">
					<li><h3>Ningún producto</h3><a href=""></a></li>
...
<div class="mens">    
  <div class="main">
     <div class="wrap">
     	<ul class="breadcrumb breadcrumb__t"><a class="home"> </a>( Nombre Usuario )</a> | <a href="checkout.html"> Ver Carrito de Compras</a></ul>
