...
<body>
	...
	<div class="header-bottom">
	    <div class="wrap">
			...
			<li><a class="color4" href="Roman_Curtains.html">Cortinas Romanas</a></li>				
			...
			<div class="wrap">
		       ...
		       <div class="f-list2">
				<ul>
					...
					<li><a href="delivery.html">Entrega y Devoluciones</a></li> |
					<li><a href="delivery.html">Terminos y Condiciones</a></li> |
