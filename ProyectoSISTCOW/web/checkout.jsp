    ...
    <body>
        ...
        <div class="register_account">
            <div class="wrap">
                ...
                <h4 class="title">Carrito de compras vacio</h4>
                <p class="cart">Aun no has escogido nungun producto para añadir al carrito de compras. Recuerda que para ello debes estar registrado.<br>Click<a href="index.html"> Aqui</a> para continuar tu Cotizacion</p>
                </br>
                </br>
                </br>
                </br>
