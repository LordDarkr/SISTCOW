    ...
    <body>
        ...
        <div class="mens">    
            ...
            <div class="main">
                ...
                <center>
                    <h3 class="m_3">Actualizar Datos</h3></center>
                <center>
                    </br>
                    <div>
                        <div class="col_1_of_CHP span_1_of_CHP">
                            <form action="" method="post" name="login" id="login-form"><fieldset class="input">				   
                                    ...
                                    <input id="Actual_Pass" type="text" name="NewNombre" class="inputbox" size="18" autocomplete="off">

                                    <label for="NewApellido">Apellido </label>
                                    <input id="NewApellido" type="text" name="NewApellido" class="inputbox" size="18" autocomplete="off">

                                    <label for="NewEmail">E-Mail</label>
                                    <input id="NewEmail" type="text" name="NewEmail" class="inputbox" size="18" autocomplete="off">

                                    <label for="Newdireccion">Direcci&oacute;n</label>
                                    <input id="NewDireccion" type="text" name="NewDireccion" class="inputbox" size="18" autocomplete="off">

                                    <label for="NewTelefono">Tel&eacute;fono</label>
                                    <input id="NewTelefono" type="text" name="NewTelefono" class="inputbox" size="18" autocomplete="off">

                                    <div class="remember">
                                        <p id="login-form-remember">
                                        </p>
                                        <input type="submit" name="update" class="button" value="Actualizar"><div class="clear"></div>
                                    </div>
                                </fieldset>
                            </form>
                        </div>  </center>
